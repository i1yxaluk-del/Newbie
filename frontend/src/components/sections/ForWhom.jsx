...
const SEGMENTS = [
  {
    ...
    outcome: "Bronze или Silver: мониторинг + бэкапы + SLA. Фиксированная плата 25–50k ₽/мес вместо штатного сисадмина.",
    plan: "Bronze · Silver",
  },
  {
    Icon: Stethoscope,
    ...
    outcome: "Gold: Wazuh SIEM, Kaspersky, документированный доступ, отчёты для проверяющих. 85–120k ₽/мес.",
    plan: "Gold",
  },
  {
    Icon: Factory,
