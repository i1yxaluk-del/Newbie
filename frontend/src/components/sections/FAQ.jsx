...
const QA = [
  ...
  },
  {
    ...
    a: "Да. Вся инфраструктура на Yandex Cloud — дата-центры в РФ. Бэкапы шифруются AES-256 на стороне клиента до отправки. Заключаем договор-поручение на обработку ПДн. Ключи шифрования остаются у вас.",
  },
  {
