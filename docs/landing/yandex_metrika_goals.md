...
Скопировать код счетчика и вставить в `<head>` лендинга (или через React-helmet):
...
В React: установить `REACT_APP_YM_COUNTER_ID` в `.env.production`.
...
*Обновлено: v4.2 · 2026-06 · новый интерфейс Метрики (профиль сайта, 2025+)*